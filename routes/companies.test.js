...
describe("GET /companies", function () {
  ...
  test("gets list of companies filtered by name", async () => {
  ...
  test("gets list of companies filtered by name and employee number", async () => {
    const res = await request(app).get("/companies")
  ...
  test("returns 400 error if minEmployees > maxEmployees", async () => {
    const res = await request(app).get("/companies")
                      .query({ minEmployees: 99, maxEmployees: 1 });
